...
Buffer.prototype.writeLongLE = Buffer.prototype.writeInt64LE = function(value, offset, noAssert)
{
  offset = offset || 0;
  var result = parser(value);
  this.writeInt32LE(result.getLowBits(), offset, noAssert);
...
Buffer.prototype.writeULongBE = Buffer.prototype.writeUInt64BE = function(value, offset, noAssert)
{
  ...
  this.writeUInt32BE(result.getLowBits(), offset + 4, noAssert);
  return this;
};
...
buffer.writeLongBE(-214748365);

console.log(buffer);

console.log(buffer.readLongBE());