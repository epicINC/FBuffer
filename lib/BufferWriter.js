...
module.exports = function()
{
  ...
  this.ulong = this.uint64 = function(value, index)
  {
    push({ val: value, type: 'ulong' }, index);
    return this;
  };

  this.long = this.int64 = function(value, index)
  {
    push({ val: value, type: 'long' }, index);
    return this;
  };

  this.double = function(value, index)
  {
    push({ val: value, type: 'double' }, index);
    return this;
  };
